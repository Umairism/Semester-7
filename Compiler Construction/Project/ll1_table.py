...
class LL1ParsingTable:
    ...
    def build_table(self):
        ...
        # Initialize table for all non-terminals and terminals
    ...
    def print_table_compact(self):
        """Print table in compact form with production numbers"""
        terminals = sorted(self.grammar.terminals)
        non_terminals = sorted(self.grammar.non_terminals)
        
        print("\n" + "="*80)
        print("LL(1) PARSING TABLE (Compact - Production Numbers)")
        print("="*80)
        
        # Get all productions with numbers
        all_productions = self.grammar.get_all_productions_numbered()
        
        # Print productions reference
        print("\nProductions:")
